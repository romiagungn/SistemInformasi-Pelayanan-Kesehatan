            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                     ...
                     <li>
                        <a class="active-menu" href="proses.php"><i class="fa fa-desktop fa-3x"></i> Lihat Proses</a>
                    </li>
					<li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="lihat_obat.php">Lihat Data Obat</a>
                                    </li>
                                    <li>
                                        <a href="lihat_obatKadaluarsa.php">Lihat Data Obat kadaluarsa</a>
                                    </li>
