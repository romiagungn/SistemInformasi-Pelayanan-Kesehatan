<html>
	...
	<body>
        ...
        <td width="10"></td>
        <td><h5>Laporan Permintaan Obat<br>Klinik GreenCare Bandung<br> Jln.Cipamokolan no.22</h5></td>
			</tr></table>	
<?php
...
$print3 = mysql_query("select * from permintaan where id_permintaan='".$_GET["nmr"]."'");
$printDb3 = mysql_fetch_assoc($print3);
$print = mysql_query("select * from detail_permintaan where id_permintaan='".$_GET["nmr"]."'");
}
?>			
...
<?php 
	...
	$count_query   = mysql_query("SELECT COUNT(id_permintaan) AS numrows, id_permintaan,id_obat,jumlah,status FROM detail_permintaan where id_permintaan='".$_GET["nmr"]."'");
	...
	$query = mysql_query("Select id_permintaan,id_obat,jumlah,status,persetujuan FROM detail_permintaan where id_permintaan='".$_GET["nmr"]."'");

?>
<table class="tabel5" border="0" style='text-align: left' align="center">
				<tr>
					<td align="left" width="100">NO Permintaan</td>
					<td align="center" width="10">:</td>
					<td align="left" width="130"><?php echo $printDb3["id_permintaan"];?></td>
				</tr>
				<tr>
					<td align="left" width="100">Tanggal Permintaan</td>
					<td align="center" width="10">:</td>
			...
			<table class="tabel5" width="500" border="1" align="center">
				<tr>
					<td align="center" width="100">KODE OBAT</td>
					<td align="center" width="100">NAMA OBAT</td>
					<td align="center" width="100">JENIS OBAT</td>					
					<td align="center" width="100">JUMLAH PERMINTAAN</td>
				</tr>
