            ...
            <div id="page-inner">
				...
				<!-- Advanced Tables -->
					...
					<?php
                        ...
                        <tr>
                          ...
                          <td class="center">
                            <div class="centered">
                              ...
                              <a href="lihat_obat.php?act=del&id_obat=<?php echo $id_obat;?>" class="btn btn-warning" title="Delete"><i class="glyphicon glyphicon-trash"></i></a>
							   </div>
                            </td>
                        </tr>
                        <?php
                        ...
                        ?>
<?php 
$periksa=mysql_query("select * from t_obat where stok_obat <=20");
while($q=mysql_fetch_array($periksa)){	
	if($q['stok_obat']<=20){	
		...
		<?php
		echo "<div style='padding:5px' class='alert alert-warning'><span class='glyphicon glyphicon-info-sign'></span> Stok  <a style='color:red'>". $q['nama_obat']."</a> yang tersisa sudah kurang dari 20 . silahkan pesan lagi !! <a href='tambah_permintaan.php'>Pesan ?</a></div>";	
	}
}
?>	
                        </form>
...
if($query ){
  ...
  document.location.href='lihat_obat.php';
  </script>";
}
else{
  mysql_error();
