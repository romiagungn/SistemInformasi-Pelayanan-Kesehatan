...
<table width="400" border="1" cellpadding="0">
  ...
  <tr>
	...
	<td width="120"><div align="center"><b>Tanggal Obat Masuk</b></div></td>
	<td width="100"><div align="center"><b>Jumlah Obat Masuk</b></div></td>
	<td width="100"><div align="center"><b>Stok Obat Akhir</b></div></td>
	<td width="100"><div align="center"><b>Tanggal Kadaluarsa</b></div></td>
  </tr>
<?php
$query 	= mysql_query("SELECT detail_penerimaan.*, penerimaan.*, t_obat.* FROM detail_penerimaan
						INNER JOIN penerimaan ON detail_penerimaan.id_penerimaan=penerimaan.id_penerimaan
...
?>
    ...
    <td width="80"><div align="center"><?php echo $data['kadaluarsa']; ?></div></td>
  </tr>
<?php } ?>
</tbody>
<tfoot>
