				...
				<!-- Advanced Tables -->
					...
					<?php
                        ...
                        while ($hasil = mysql_fetch_array($sql))
                        {
						  ...
						  ?>
<?php 
$query2=mysql_query("select * from t_obat where stok_obat <=5");
while($q=mysql_fetch_array($query2)){	
	if($q['stok_obat']<=5){	
		...
		<?php
		echo "<div style='padding:5px' class='alert alert-warning'><span class='glyphicon glyphicon-info-sign'></span> Stok  <a style='color:red'>". $q['nama_obat']."</a> yang tersisa sudah kurang dari 5 . silahkan pesan lagi ke supplier!!</div>";	
	}
}
?>		
