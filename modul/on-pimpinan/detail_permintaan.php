...
include '../../fungsi/paging.php'; //include pagination file
	...
	$edit = mysql_query("select * from detail_permintaan where id_permintaan='".$_GET["nmr"]."'   LIMIT $offset,$per_hal");
	}
?>
            ...
            <ul class="list-group">
                <li class="list-group-item active">
                    <div class="row">
                        ...
                        <div class="col-md-3"></div>
                        <div class="col-md-3" align="right"><a href="lihat_permintaan2.php" class="btn btn-info">Lihat Data Permintaan</a></div>
                    </div>
                </li>
				<li>
				<form>
