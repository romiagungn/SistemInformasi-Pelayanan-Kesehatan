...
$edit = mysql_query("select * from detail_penerimaan where id_penerimaan='".$_GET["nmr"]."'");
}
?>
                ...
                <div class="row">
                    <div class="col-md-12">
                     <h2>Daftar Permintaan Belum Di ACC</h2>   
                        <h5>Silahkan ACC Jika Diijikan</h5>
                    </div>
                </div>
					<hr>
					<hr>
        ...
        <div class="well">
            <ul class="list-group">
                <li class="list-group-item active">
                    <div class="row">
                        <div class="col-md-3"><h4>Detail Penerimaan</h4></div>
                        <div class="col-md-3"></div>
                        <div class="col-md-3"></div>
                        <div class="col-md-3" align="right"><a href="lihat_penerimaan2.php" class="btn btn-info">Lihat Data Penerimaan</a></div>
                    </div>
                </li>
				...
				<?php while ($hasil=mysql_fetch_array($edit)){ 
					$id_penerimaan=$hasil['id_penerimaan'];
