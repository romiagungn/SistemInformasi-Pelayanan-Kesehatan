<?php 
	...
	$query = mysql_query("Select permintaan.id_permintaan,permintaan.tanggal,permintaan.persetujuan,detail_permintaan.status FROM permintaan ,detail_permintaan where permintaan.id_permintaan=detail_permintaan.id_permintaan and persetujuan='1'  GROUP BY id_permintaan LIMIT $offset,$per_hal");
...
<tr>
	...
	<td>
		<div class='btn-group'>
			<a href="detail_permintaan.php?aksi=lihat&nmr=<?php echo $result['id_permintaan']; ?>" class="btn btn-xs btn-info" title='lihat Detail Permintaan' > <i class="glyphicon glyphicon-file"></i> </a>
		<a href="?aksi=hapus&nmr=<?php echo $result['id_permintaan']; ?>" class="btn btn-xs btn-info" title='setujui Permintaan ini'onclick="return confirm('ANDA YAKIN MENSETUJUI PERMINTAAN OBAT INI ... ?')"> <i class="glyphicon glyphicon-check"></i> </a>
		</div>
	</td>
 </tr>
<?php
