...
if ( !isset($_SESSION['user_login']) || 
    ( isset($_SESSION['user_login']) && $_SESSION['user_login'] != 'pendaftaran' ) ) {
...
font-size: 16px;"><?php echo date("d-m-Y");?> - <?php echo $jam=date("H:i:s");	;?> &nbsp;Klinik Green Care Bandung &nbsp;<a href="./../../logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
		...
		$query = "SELECT * FROM t_user WHERE level_user='pendaftaran'";
		...
		while ($hasil = mysql_fetch_array($sql))
		{
		  $nama = $hasil ['nama'];                         
         ?>	
                     <h2>Selamat Datang <?php echo $nama; ?> Di halaman Pendaftaran</h2>   
