...
<td>						
  ...
  $(document).ready(function(){
	 ...
	 +"<td><input  name='banyak_obat[]' class='form-control' type='text' placeholder='Jumlah Obat..' ></td>"
	 ...
	 +"<select name='dosis[]' class='form-control'><option value='1 x 1 per hari'>1 x 1 per hari</option>"
		...
		+"<option value='4 x 1 per hari'>4 x 1 per hari</option>"
		+"</select>			</td>"
		+"<td><input  name='keterangan_Pakai[]' class='form-control' type='text' placeholder='keterangan pakai..' ></td>");
