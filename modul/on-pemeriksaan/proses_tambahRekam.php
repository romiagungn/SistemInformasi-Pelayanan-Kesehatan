<?php
	...
	$cek = mysqli_query($koneksi, "SELECT * FROM t_rekam WHERE id_rekam='$id_rekam'");
		if(mysqli_num_rows($cek) == 0){
			...
			$simpan_resep=mysql_query("INSERT INTO detail_resep (id_rekam,id_obat,jumlah_obat,satuan,keterangan_Pakai,dosis) VALUES('$id_rekam','$idobat[$i]','$banyak_obat[$i]','$satuan[$i]','$keterangan_Pakai[$i]','$dosis[$i]')");
			}
