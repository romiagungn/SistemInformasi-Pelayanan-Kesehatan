						...
						<div class="row">
						  <div class="col-lg-12">
							...
							<tbody>
							  ...
							  <td class="center">
									<div class="centered">
									<a href="tambahrekam.php?act=edit&id=<?php echo $data['id_daftar'];?>&id_pasien=<?php echo $data['id_pasien'];?>" class="btn btn-primary" title="Tambah Rekam Medis"><i class="fa fa-edit"></i> Rekam Medis</a>
									</td>
								</div>
							</tr>
							</tbody>
